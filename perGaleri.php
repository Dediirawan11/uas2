...
<head>
    ...
    <title>Galeri ekstrakulikuler SMK N 1 pggs</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light navbarKu fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand" href="#">
                <img src="images/logo.png" alt="Logo SMK N 1 pggs">
                <h1>SMK Negeri 1<br>pggs</h1>
            </a>
    ...
    <div class="container perGaleri">
        ...
        <img src="silat.jpeg" alt="Galeri silat">
        <img src="marcing band.jpg" alt="Galeri marcing band">
        <img src="paskibra.jpg" alt="Galeri paskibra">
        <img src="robotik.jpg" alt="Galeri robotik">
        <img src="paskibra1.jpeg" alt="Galeri Pramuka">
        <img src="paduan suara.jpg" alt="Galeri paduan suara">
        ...
        <img src="images/5e72f7134ca67-integrity-desktop2.jpg" alt="Galeri silat">
        <img src="silat1.jpeg" alt="Galeri silat">
    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="footerContactUs">
                        ...
                        <div class="perFooterContactUs">
                            ...
                            <p class="text-white">smkn1pggs.com</p>
                        </div>

                        <div class="perFooterContactUs">
                            <i class="fas text-white fa-phone-alt"></i>
                            <p class="text-white">082275869735</p>
                        </div>

                        <div class="perFooterContactUs">
                            <i class="fas text-white fa-road"></i>
                            <p class="text-white">Jl. aornakan II, Kec. kecupak - Kab. Pakpak bharat</p>
                        </div>
                ...
                <div class="col-md-4 text-center">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <input class="form-control" type="search" placeholder="smkn1gmail.com"
                                aria-label="Search">
    ...
    <div class="footerCopyright">
        <p class="text-white">
            <i class="far fa-copyright"></i>2023 By : <span>om dedi</span>.&nbsp; Inspired by <a
                href="">ACS
                sumatra utara</a>
        </p>
    </div>
