<?php include "header.php"; ?>
    ...
    <div class="container">
        <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
                <tr>
                    <td><img width="100" height="50" src="images/5e72f65c1f909-teamwork-desktop2.jpg" alt=""></td>
                    <td>Pramuka</td>
                ...
                <tr>
                    <td><img width="100" height="50" src="silat1.jpeg" alt=""></td>
                    <td>silat</td>
                    <td><a href="" class="btn btn-primary">Selengkapnya</a></td>
                </tr>

                <tr>
                    <td><img width="100" height="50" src="marcing band.jpg" alt=""></td>
                    <td>marching band</td>
                    <td><a href="" class="btn btn-primary">Selengkapnya</a></td>
                </tr>

                <tr>
                    <td><img width="100" height="50" src="paskibra1.jpeg" alt=""></td>
                    <td>paskibra</td>
                    <td><a href="" class="btn btn-primary">Selengkapnya</a></td>
                </tr>

                <tr>
                    <td><img width="100" height="50" src="paduan suara.jpg" alt=""></td>
                    <td>paduan suara</td>
                    <td><a href="" class="btn btn-primary">Selengkapnya</a></td>
                </tr>
                ...
                <tr>
                    <td><img width="100" height="50" src="robotik.jpg" alt=""></td>
                    <td>robotik</td>
                    <td><a href="" class="btn btn-primary">Selengkapnya</a></td>
                </tr>
            </tbody>
