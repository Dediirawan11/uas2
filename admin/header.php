    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">SMK N1 PGGS</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li>
							<a href="tampil-mahasiswa.php"><span class="glyphicon glyphicon-user"></span> siswa</a>
						</li>
            <li>
							<a href="tampil-dosen.php"><span class="glyphicon glyphicon-user"></span> guru</a>
						</li>
            <li>
